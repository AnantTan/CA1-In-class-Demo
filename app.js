...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('TescoStore.xml', 'utf8'); //We are reading in the XML file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('TescoStore.xml', function(err, result) {
      if (err) throw (err);
      ...
      result.tescostock.section[obj.sec_n].entree.push({'item': obj.item, 'price': obj.price}); //If your XML elements are differet, this is where you have to change to your own element names
      //Converting back to our original XML file from JSON
      jsToXmlFile('TescoStore.xml', result, function(err) {
...
router.post('/post/delete', function(req, res) {
  ...
  function deleteJSON(obj) {
    ...
    xmlFileToJs('TescoStore.xml', function(err, result) {
      ...
      delete result.tescostock.section[obj.section].entree[obj.entree];
